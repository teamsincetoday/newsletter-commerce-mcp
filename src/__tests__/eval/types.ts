 ...
 *
 * Adapted from podcast-commerce-mcp eval framework.
...
export interface ExpectedProduct {
  ...
  minStrength?: "strong" | "endorsed" | "mentioned" | "organic";
}
